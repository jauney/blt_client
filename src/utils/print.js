  ...
  let html = `
    ...
    <table>
      ...
      <tr class="txt-desc">
        ...
        <td class="col2-2">
          <div>运输协议：1. 货物按国家标安全标准，不准托运危险品和国家禁用物品，否则一切后果由托运人负责。2. 所运物品自愿投保，如未投保，按照所丢失货物运费3-5倍赔付，如有保险按投保价赔付。3. 一切货损在总价值的3%以内属正常，本公司不负赔偿责任。4. 易碎物品，本公司只负责丢失赔偿责任，不负责损坏赔偿责任。5. 货物到达目的地后，如外包装完好，本部不负责内部质量与数量问题。6. 发货人应自觉签字确认，确保发货无误，如不签字者本公司将默认已签署。</div>
        </td>
      </tr>
    </table>
    </div>
